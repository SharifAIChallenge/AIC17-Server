 ...
 * {@link GameLogic GameLogic} class which represents the main game logic engine of the game.
 * <p>
 * The user must fill in this method to return the preferred subclass of the
 * {@link GameLogic GameLogic} in order to be used in the
 * {@link GameHandler GameHandler} class
 * </p>
 */
public interface Factory {
     ...
     *
     * @return The preferred child of the {@link GameLogic GameLogic} class
     */
