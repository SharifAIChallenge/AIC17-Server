 ...
 * <p>
 * All of the required efforts for connecting a client to that server is done by the parent class called {@link NetServer}
...
public class TerminalNetwork extends NetServer {
    ...
    /**
     * An instance of {@link TerminalNetwork} used to
     */
    ...
    /**
     * This thread is used by {@link TerminalNetwork}
    ...
    class TerminalNetworkThread extends Thread {
         ...
         *
         * @see #TerminalNetworkThread(network.JsonSocket)
         * @see #checkInput()
         */
        @Override
        public void run() {
         ...
         *
         * @throws java.io.IOException if the input is invalid
         */
